...
export function ThreeDCardDemo({ name, image, description }: DataProps) {
  return (
    <CardContainer className="inter-var">
      <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[35rem] h-auto rounded-xl p-6 border  ">
        ...
        {/* <div className="flex justify-between items-center mt-20">
          ...
          >
            <a href="https://next-hill-6732.vercel.app/" target="_blank">
              Live →
            </a>
          </CardItem>
          <CardItem
          ...
          >
            <a
              href="https://github.com/G-Dharani-raj/Lens-studio"
              target="_blank"
            >
              Github
            </a>
