...
const projects = [
  ...
  {
    icon: "https://www.impekable.com/wp-content/uploads/2023/05/Next_JS-500x500.png",
    name: "Next JS",
    category: "frontend",
  },
  {
  ...
  {
    icon: "https://assets.super.so/e7c0f16c-8bd3-4c76-8075-4c86f986e1b2/uploads/favicon/9c68ae10-0a8a-4e3f-9084-3625b19df9cb.png",
    name: "Github",
    category: "tool",
  },
  {
    icon: "https://repository-images.githubusercontent.com/252413723/e6f28180-8882-11ea-9e76-78d72dfa2af0",
    name: "Github",
    category: "tool",
  },
  {
  ...
  {
    icon: "https://pbs.twimg.com/media/FxoIFVgagAE-gqB?format=png&name=4096x4096",
    name: "Github",
    category: "tool",
  },
  {
